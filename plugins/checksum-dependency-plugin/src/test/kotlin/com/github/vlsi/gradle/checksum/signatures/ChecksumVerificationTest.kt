        ...
        if (!result.output.normalizeEol().contains(
            ...
            Checksum/PGP violations detected on resolving configuration :classpath
              ...
              No trusted PGP keys are configured for group com.googlecode.javaewah:
                com.googlecode.javaewah:JavaEWAH:1.1.6 (pgp=[72475fd306b9cab7], sha512=[computation skipped])
              No trusted PGP keys are configured for group com.jcraft:
                com.jcraft:jsch:0.1.55 (pgp=[a50569c7ca7fa1f0], sha512=[computation skipped])
                com.jcraft:jzlib:1.1.1 (pgp=[a50569c7ca7fa1f0], sha512=[computation skipped])
              No trusted PGP keys are configured for group org.bouncycastle:
                org.bouncycastle:bcpg-jdk15on:1.61 (pgp=[b341ddb020fcb6ab], sha512=[computation skipped])
                org.bouncycastle:bcpkix-jdk15on:1.61 (pgp=[b341ddb020fcb6ab], sha512=[computation skipped])
                org.bouncycastle:bcprov-jdk15on:1.61 (pgp=[b341ddb020fcb6ab], sha512=[computation skipped])
              No trusted PGP keys are configured for group org.eclipse.jgit:
                org.eclipse.jgit:org.eclipse.jgit:5.4.0.201906121030-r (pgp=[5b05ccde140c2876], sha512=[computation skipped])
              No trusted PGP keys are configured for group org.slf4j:
                org.slf4j:slf4j-api:1.7.2 (pgp=[2c7b12f2a511e325], sha512=[computation skipped])

            Checksum/PGP violations detected on resolving configuration :tmp
              No trusted PGP keys are configured for group org.jodd:
                org.jodd:jodd-core:5.0.6 (pgp=[91ae1504568ec4dd], sha512=[computation skipped])
            """.trimIndent().normalizeEol())) {
    ...
    fun `PGP is required but asc signature is not available`(gradleVersion: String) {
        ...
        val result =
            prepare(gradleVersion, "allDependencies", "--quiet", "--info", "--stacktrace")
                .buildAndFail()
        Assertions.assertTrue(
            result.output.contains("No PGP signature (.asc file) found for artifact, Expecting one of the following PGP signatures: [cafebabecafebabe], but artifact is signed by [] only")
        ) {
